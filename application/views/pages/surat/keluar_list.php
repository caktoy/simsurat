      ...
      <tr>
        ...
        <td style="text-align: center;width: 10%;">
          <div class="hidden-sm hidden-xs action-buttons">
            <a class="blue" href="<?php echo base_url().'index.php/surat/keluar_detil/'.$s->ID_SURAT; ?>">
              <i class="ace-icon fa fa-eye bigger-130"></i>
            </a>

            <a class="green" href="<?php echo base_url().'index.php/surat/keluar_ubah/'.$s->ID_SURAT; ?>">
              <i class="ace-icon fa fa-pencil bigger-130"></i>
            </a>

            <a class="red" href="<?php echo base_url().'index.php/surat/keluar_hapus/'.$s->ID_SURAT; ?>"
