  ...
  <div class="col-sm-5">
    <div class="widget-box">
      <div class="widget-header widget-header-flat">
        <h4 class="widget-title smaller">Tambah Data Media</h4>
      </div>
      <div class="widget-body">
        <div class="widget-main">
          <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/master/media_act/tambah' ?>">
        ...
        <tr>
          ...
          <td style="text-align: center;width: 20%;">
            <div class="hidden-sm hidden-xs action-buttons">
  						<a class="green" href="#modal-edit" data-toggle="modal" role="button" onclick="edit('<?php echo $m->ID_MEDIA; ?>', '<?php echo $m->NAMA; ?>')">
  							<i class="ace-icon fa fa-pencil bigger-130"></i>
  						</a>

  						<a class="red" href="<?php echo base_url().'index.php/master/media_act/hapus-'.$m->ID_MEDIA; ?>" onclick="return confirm('Anda yakin?');">
...
<div id="modal-edit" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
      ...
      <form class='form-horizontal' role='form' action='<?php echo base_url()."index.php/master/media_act/ubah"; ?>' method='post'>
