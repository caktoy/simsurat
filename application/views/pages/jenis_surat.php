  ...
  <div class="col-sm-5">
    <div class="widget-box">
      <div class="widget-header widget-header-flat">
        <h4 class="widget-title smaller">Tambah Data Jenis Surat</h4>
      </div>
        ...
        <tr>
          ...
          <td style="text-align: center;width: 20%;">
            <div class="hidden-sm hidden-xs action-buttons">
  						<a class="green" href="#modal-edit" data-toggle="modal" role="button" onclick="edit('<?php echo $j->ID_JENIS; ?>', '<?php echo $j->NAMA; ?>')">
  							<i class="ace-icon fa fa-pencil bigger-130"></i>
  						</a>

  						<a class="red" href="<?php echo base_url().'index.php/master/jenis_act/hapus-'.$j->ID_JENIS; ?>" onclick="return confirm('Anda yakin?');">
...
<div id="modal-edit" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
      ...
      <form class='form-horizontal' role='form' action='<?php echo base_url()."index.php/master/jenis_act/ubah"; ?>' method='post'>
